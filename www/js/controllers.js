...
.controller('MainController', function($scope, $state, $rootScope, $stateParams, $ionicHistory) {
    ...
    .controller('PrchatController', ['$scope', '$timeout', '$ionicFrostedDelegate', '$ionicScrollDelegate', '$rootScope', function($scope, $timeout, $ionicFrostedDelegate, $ionicScrollDelegate, $rootScope) {
        ...
        $scope.save = function() {
            var gameScore = new messageChatParse();
            messageChatParse.set ("from", $rootScope.user);
            gameScore.set("name",  "Vasya");
            gameScore.set ("cheat", false);

            gameScore.save(null, {
                success: function (gameScore) {
                    // Execute any logic that should take place after the object is saved.
                    console.log('New object created with objectId: ' + gameScore.id);
                    $scope.id = gameScore.id;
                },
